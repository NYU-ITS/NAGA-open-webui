...
####################
# Default System Function (LLM Portkey)
####################

DEFAULT_SYSTEM_FUNCTION_ID = "system_default_llm"

# Must exactly match the `version:` field in the frontmatter of
# 2_Dev_Tasks_PilotGenAI/2.1_Scope_for_Function/supportingdocs/LLM Portkey (1).txt
# Any mismatch triggers the upgrade path on every restart.
...
# One-time migration flag: have we already adopted/seeded the System default
# function for pre-existing workspaces? See
# 2_Dev_Tasks_PilotGenAI/2.1_Scope_for_Function/implementation/02_existing_workspace_adoption.md
DEFAULT_FUNCTION_ADOPTION_DONE = PersistentConfig(
    "DEFAULT_FUNCTION_ADOPTION_DONE",
    "function.default_adoption_done",
    False,
)
